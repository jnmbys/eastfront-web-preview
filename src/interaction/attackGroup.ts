import { validateAttackAction, type EntityId } from '../core-adapter/core.js';
...
export function primaryAttackerId(presentation:PresentationState):EntityId|null {
...
export function additionalAttackerIssues(session:LocalGameSession,presentation:PresentationState,unitId:EntityId) {
...
export function eligibleAdditionalAttackerIds(session:LocalGameSession,presentation:PresentationState):EntityId[] {
