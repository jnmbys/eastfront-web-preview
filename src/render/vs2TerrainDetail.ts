...
function slope(seed: number, layer: string, u: number, v: number) {
...
export function vs2ReliefLight(seed: number, x: number, y: number, rough: boolean): number {
...
export function vs2MarshEnvironment(seed: number, x: number, y: number) {
