...
export interface PresentationState {
  ...
  primaryAttackerId: EntityId | null;
...
export function clearCombatDrafts(presentation:PresentationState):void {
  presentation.attackUnitIds=[];presentation.primaryAttackerId=null;presentation.attackTarget=null;presentation.attackerArtilleryUnitId=null;
