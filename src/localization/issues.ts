import { msg, formatMessage, type Message, type MessageKey } from './index.js';
export interface PlayerIssue {code:string;message?:string;details?:Readonly<Record<string,unknown>>;}
...
const specificKeys:Readonly<Record<string,MessageKey>> = {
...
export const joinIssues=(issues:readonly PlayerIssue[]):Message=>({parts:issues.map(issueMessage),separator:' · '});
