...
function combatPanel(model:BrowserRenderModel):string{
  ...
  if(!pending)return combatAttackPanel(model,c.attackDraft.preview?combatContextHtml(c.attackDraft.preview,'COMBAT DETAILS'):'')+battleHistoryHtml(model);
