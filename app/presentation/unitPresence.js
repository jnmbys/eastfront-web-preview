import { PRESENCE_FAMILY, PRESENCE_LOD, PRESENCE_PALETTE } from './unitPresenceTypes.js';
...
export class UnitPresenceLayer {
    ...
    create(identity, counter) {
        ...
        if (/selected|combat-attacker-(primary|selected)/.test(classes))
            node(doc, 'ellipse', { cx: 0, cy: 6, rx: 24, ry: 6, fill: 'none', stroke: palette.accent, 'stroke-opacity': .45, 'stroke-width': 1 }, pedestal);
