...
test('every pending Combat UX panel and all actual phases render Chinese with CRT codes retained',()=>{
 ...
 for(const kind of ['DEFENDER_REACTION','LOSS_ALLOCATION','RETREAT','ADVANCE_AFTER_COMBAT','BREAKTHROUGH_OPTION','SCHWERPUNKT_OPTION']){
  const model={...base,combat:{history:[],battle,reaction:{artillery:[],hq:[]},advance:{unitIds:['G-PZ-01'],selectedUnitId:'G-PZ-01',target:{q:3,r:-1}},pending:{kind,side:s.state.activeSide,battleId:'B-000001',decisionOwnerControllerId:s.activeViewerControllerId,eligibleArtilleryUnitIds:[],eligibleUnitIds:['G-PZ-01']},loss:{steps:1,eligibleUnitIds:['G-PZ-01'],capacityByUnitId:{'G-PZ-01':2},draft:[]},retreat:{steps:1,unitIds:['S-I-01'],activeUnitId:'S-I-01',completeUnitIds:[],options:[{q:3,r:-1}],drafts:{}},breakthrough:{maxHexes:2,eligibleUnitIds:['G-PZ-01'],selectedUnitId:'G-PZ-01',path:[]},schwerpunkt:{target:{q:3,r:-1},choices:[{unitId:'G-PZ-01',target:{q:3,r:-1}}],eligibleUnitIds:['G-PZ-01']}}};
...
test('counter mechanics and symbols are identical across locales; only accessible text changes',()=>{
 ...
 const normalize=s=>s.replace(/aria-label="[^"]*"/g,'').replace(/<title>[^<]*<\/title>/g,'').replace(/(<text class="compact-category"[^>]*>)[^<]*/g,'$1');
