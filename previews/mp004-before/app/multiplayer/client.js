...
export class LobbyClient {
    ...
    notify(message = null) {const __end=trace.begin("LobbyClient.notify");try{
    ...
    open() {
        ...
        socket.onmessage = event => {
            ...
            let message;
            try {
                message = trace.parse(String(event.data));
    ...
    receive(message) {const __end=trace.begin("LobbyClient.receive");try{
