...
export const unitLabel = (type) => enumLabel(type);
export function commandHeader(model) {const __p4end=perf4.begin("ui/commandPresentation.js:commandHeader");try{
...
export function deploymentLocations(model, selected, ui) {const __p4end=perf4.begin("ui/commandPresentation.js:deploymentLocations");try{
...
export function unitDescription(type) {
    const descriptions = { INFANTRY: t('unit.infantryDescription'), ELITE_INFANTRY: t('unit.eliteDescription'), JAGER: t('unit.jagerDescription'), PANZER: t('unit.panzerDescription'), TANK: t('unit.tankDescription'), HEAVY_TANK: t('unit.heavyDescription'), ARTILLERY: t('unit.artilleryDescription'), ENGINEER: t('unit.engineerDescription'), RECON: t('unit.reconDescription'), MOTORIZED: t('unit.motorizedDescription'), ANTI_TANK: t('unit.atDescription'), HQ: t('unit.hqDescription') };
