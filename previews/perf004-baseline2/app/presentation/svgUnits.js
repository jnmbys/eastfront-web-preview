...
export class SvgUnitPresentation {
    ...
    bind(root, identities = []) {const __p4end=perf4.begin("presentation/svgUnits.js:SvgUnitPresentation.bind");try{
    ...
    paint(states) {const __p4end=perf4.begin("presentation/svgUnits.js:SvgUnitPresentation.paint");try{
