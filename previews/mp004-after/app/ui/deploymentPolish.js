import { msg, formatMessage } from '../localization/index.js';
import { hexPolygon } from '../geometry/hex.js';
export function deploymentRejectionMessage(issues) {
    const keys = { STACKING_LIMIT: 'deployment.stackLimit', INVALID_DEPLOYMENT_HEX: 'deployment.invalidHex', DEPLOYMENT_UNIT_UNAVAILABLE: 'deployment.unavailable', WRONG_PHASE: 'deployment.wrongPhase', WRONG_SIDE: 'deployment.wrongSide', INVALID_CONTROLLER: 'deployment.invalidController' };
...
export function deploymentRejection(issues) { return formatMessage(deploymentRejectionMessage(issues)); }
