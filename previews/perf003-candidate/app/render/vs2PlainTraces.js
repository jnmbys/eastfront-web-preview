...
export function paintVS2PlainTracesAsync(ctx, p, seed, control) { return runTerrainWork('paintVS2PlainTraces', paintVS2PlainTracesWork(ctx, p, seed), control); }
export function paintVS2MarshReeds(ctx, p, seed) { return finishTerrainWork(paintVS2MarshReedsWork(ctx, p, seed)); }
export function paintVS2MarshReedsAsync(ctx, p, seed, control) { return runTerrainWork('paintVS2MarshReeds', paintVS2MarshReedsWork(ctx, p, seed), control); }
export function paintVS2RiverbankDetails(ctx, p, seed) { return finishTerrainWork(paintVS2RiverbankDetailsWork(ctx, p, seed)); }
export function paintVS2RiverbankDetailsAsync(ctx, p, seed, control) { return runTerrainWork('paintVS2RiverbankDetails', paintVS2RiverbankDetailsWork(ctx, p, seed), control); }
