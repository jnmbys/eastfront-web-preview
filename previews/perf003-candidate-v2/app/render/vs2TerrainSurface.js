import { measureTerrainWork, runTerrainWork } from './terrainWork.js';
...
export function createVS2WorldBaseLayer(assets = vs2AssetCatalog, control) {
    return {
        ...
        async paint(ctx, model, seed, lod = 'medium') {
            ...
            measureTerrainWork('paintVS2PlainTraces', () => paintVS2PlainTraces(ctx, projection, seed));
            measureTerrainWork('paintVS2MarshReeds', () => paintVS2MarshReeds(ctx, projection, seed));
            measureTerrainWork('paintVS2RiverbankDetails', () => paintVS2RiverbankDetails(ctx, projection, seed));
